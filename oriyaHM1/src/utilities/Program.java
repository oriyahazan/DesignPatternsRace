...
public class Program {
    ...
    private static factory.RaceBuilder builder = RaceBuilder.getInstance();
    ...
    private static void initAirRace() {
        ...
        try {
            racers.add(builder.buildWheeledRacer("game.racers.air.Airplane", "Bob", 220, 10, EnumContainer.Color.BLUE, 3));
            racers.add(builder.buildWheeledRacer("game.racers.air.Airplane", "John", 175, 20, EnumContainer.Color.BLUE, 3));
            racers.add(builder.buildWheeledRacer("game.racers.air.Airplane", "Frank", 180, 15, EnumContainer.Color.BLUE, 3));
            racers.add(builder.buildRacer("game.racers.air.Helicopter", "Matt", 230, 8, EnumContainer.Color.RED));
            racers.add(builder.buildWheeledRacer("game.racers.land.Car", "car", 15, 1, EnumContainer.Color.GREEN, 3));
            racers.add(builder.buildRacer("game.racers.air.Helicopter", "Alby", 200, 8, EnumContainer.Color.BLUE));
        } catch (ClassNotFoundException | NoSuchMethodException | SecurityException | InstantiationException
                 | IllegalAccessException | IllegalArgumentException | InvocationTargetException e1) {
            e1.printStackTrace();
        }
    ...
    private static void initLandRace() {
        ...
        racers = new ArrayList<>();
        try {
            racers.add(builder.buildWheeledRacer("game.racers.land.Car", "Bob", 220, 10, EnumContainer.Color.BLUE, 4));
            racers.add(builder.buildWheeledRacer("game.racers.land.Car", "John", 175, 20, EnumContainer.Color.BLUE, 4));
            racers.add(builder.buildRacer("game.racers.land.Horse", "Frank", 180, 15, EnumContainer.Color.BLUE));
            racers.add(builder.buildRacer("game.racers.land.Horse", "Matt", 230, 8, EnumContainer.Color.RED));
            racers.add(builder.buildWheeledRacer("game.racers.land.Bicycle", "Timmy", 15, 1, EnumContainer.Color.GREEN, 3));
            racers.add(builder.buildRacer("game.racers.air.Helicopter", "Alby", 200, 8, EnumContainer.Color.BLUE));
        } catch (ClassNotFoundException | NoSuchMethodException | SecurityException | InstantiationException
                 | IllegalAccessException | IllegalArgumentException | InvocationTargetException e1) {
            e1.printStackTrace();
    ...
    private static void initNavalRace() {
        ...
        racers = new ArrayList<>();
        try {
            racers.add(builder.buildRacer("game.racers.naval.RowBoat", "Bob", 220, 10, EnumContainer.Color.BLUE));
            racers.add(builder.buildRacer("game.racers.naval.SpeedBoat", "John", 175, 20, EnumContainer.Color.BLUE));
            racers.add(builder.buildRacer("game.racers.naval.RowBoat", "Matt", 230, 8, EnumContainer.Color.RED));
            racers.add(builder.buildWheeledRacer("game.racers.land.Car", "car", 15, 1, EnumContainer.Color.GREEN, 3));
            racers.add(builder.buildRacer("game.racers.land.Car", "car", 15, 1, EnumContainer.Color.GREEN)); // intentional exception!
        } catch (ClassNotFoundException | NoSuchMethodException | SecurityException | InstantiationException
                 | IllegalAccessException | IllegalArgumentException | InvocationTargetException e1) {
            e1.printStackTrace();
        }
